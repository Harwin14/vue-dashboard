<template>
  ...
  >
    <div class="bg-gray-700 h-[50px] flex justify-center items-center">
      ...
      <img src="https://avatars.githubusercontent.com/u/97021587?v=4" v-show="!dataOpenSideBar" class="p-1 w-8 h-8 rounded-full ring-2 ring-gray-300 darkring-gray-500" alt="Avatar">
    ...
    <div class="flex flex-col justify-between h-[calc(100vh-3rem)] bg-gray-900">
      <div class="menu-man text-left px-2-whitespace-nowrap">
        <div class="profile flex justify-center items-center text-center p-5">
          <div class="text-center text-white" v-show="dataOpenSideBar">
            <img src="https://avatars.githubusercontent.com/u/97021587?v=4" class="p-1 w-24 h-24 rounded-full ring-2 ring-gray-300 darkring-gray-500 mb-4" alt="Avatar">
        ...
        <div class="py-3 rounded-md cursor-pointer text-gray-300 hover:text-white">
          <div class="px-2 flex space-x-2">
            <span class="pi pi-slack" v-tooltip="'Setting'"></span>
      ...
      <div class="menu-man">
        <div class="py-3 rounded-md cursor-pointer text-gray-300 hover:text-white">
          <a href="github.com" target="_blank" class="px-2 flex space-x-2">
            <span class="pi pi-question" v-tooltip="'About Me'"></span>
            <span v-show="dataOpenSideBar">About Me</span>
          </a>
        </div>
      </div>
    </div>
